...
def main():
    ...
    dyn = torch.load("/home/seanny/quadrotor/models/multi_step.pth.tar")
    ...
    xyz, zeta, _, uvw, pqr = iris.get_state()
    action = trim
    ...
    for i in range(steps):
        ...
        print(state_action)
        outputs = dyn(state_action)[0]
        print(outputs)
        uvw_nn, pqr_nn = outputs[:,0:3], outputs[:,0:3]
        print(uvw_nn)
        xyz_nn, zeta_nn = dyn.step(xyz_nn, zeta_nn, uvw_nn, pqr_nn, dt)
